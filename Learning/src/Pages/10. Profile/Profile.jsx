        ...
        <div className='bg-slate-100 d-flex justify-between flex-col w-72 items-center h-[500px]'>
            ...
            <div className="d-flex items-center w-full m-0">
                <div className="nav flex-column nav-pills me-3 justify-center w-full" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button className="nav-link active w-72 btn btn-dark" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">My Courses</button>
                    <button className="nav-link w-full btn btn-dark" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Update Profile</button>
